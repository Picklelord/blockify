...
TraySetIcon("headphones.ico");SpotPlayerControl.ico")
...
Func SpotControlGui()
    ...
    Local $idMute = GUICtrlCreateButton("MU", 110, 26, 24, 24, $BS_ICON)
	;$CrntSongLbl = GUICtrlCreateLabel("Current Song: ", 95, 5, 75)
