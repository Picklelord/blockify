...
Func SpotControlGui()
    ...
    Local $hGUI = GUICreate("Blockify", 530, 26, 600, 1, $WS_EX_APPWINDOW+ $WS_POPUPWINDOW, $WS_EX_TOPMOST); + $WS_MINIMIZEBOX
	...
	$CrntSongLabel = GUICtrlCreateLabel("", 205, 5, 295, 21)
	$CrntSongLbl = GUICtrlCreateLabel("Current Song: ", 125, 5, 75)
	Local $idExit = GUICtrlCreateButton("X", 504, 1, 24, 24, $BS_ICON)
	...
	GUICtrlSetImage ( $idExit, "exit.ico",1,1)
